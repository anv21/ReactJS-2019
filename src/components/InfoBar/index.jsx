              ...
              {items && items.length > 0 && (
                <div className="infoBar_wrapper">
                  ...
                  <div>
                    ...
                    <Link
                      to={`/search?search=${value}&searchBy=${searchBy}&sortBy=${
                        SORT_BY.RELEASE_DATE
                      }`}
                    >
                      <span
                        className={
                          'infoBar_sort_by_link ' +
                          (sortBy === SORT_BY.RELEASE_DATE && 'active_link')
                        }
                    ...
                    >
                      <span
                        className={
                          'infoBar_sort_by_link ' + (sortBy === SORT_BY.RATING && 'active_link')
                        }
